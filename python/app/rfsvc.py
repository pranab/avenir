...
def getClassifier():
	classifier = cache.get('rf_classifier')
	if (classifier is None):
		print "creating and caching rf classifier"
		classifier = RandomForest(configPath)
		cache.set('rf_classifier', classifier, timeout=600)   
	return classifier
