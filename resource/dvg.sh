...
PROJECT_HOME=/Users/pranab/Projects/bin/avenir
JAR_NAME=$PROJECT_HOME/uber-avenir-spark-1.0.jar
...
"binValGen")	
	...
	--conf spark.ui.killEnabled=true --master $MASTER $JAR_NAME  $INPUT $OUTPUT dvg.conf
	ls -l ./output/samp
	;;
